...
draw.ellipse((circle_x - circle_radius, circle_y - circle_radius, circle_x + circle_radius, circle_y + circle_radius), fill = "lightgreen")
#(x, y) (x, y)
draw.line(((250,125), (250, 320)), fill = 'lightgreen') #body
draw.line(((180, 250), (250, 250)), fill = 'lightgreen')# left arm
draw.line(((250,250),(315, 250)), fill = 'lightgreen') # right arm
draw.line(((250,320),(180, 420)), fill = 'lightgreen') #right leg 
draw.line(((320, 420),(250, 320)), fill = 'lightgreen') #left leg
img.show()
